...
export const CODE_DIR = 'packages/core/src/code/';
export const SVG_DIR = 'packages/core/src/generated/svgs/';
export const CHART_TS_DIR = 'packages/core/src/generated/charts/';
